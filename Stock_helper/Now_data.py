...
class Now_Data:
    ...
    def __get_now(self):
        ...
        df = pd.DataFrame({'现价', pri_now, '昨收', pri_yesterday_end, '价差', pri_Dvalue, '涨幅', pri_Increase, '今开',
                           pri_today_start, '最高', pri_high, '最低', pri_low, '今收', pri_today_now, '总手',
                           Turnover_s, '成交额', Turnover_y})
